...
def main():
    ...
    header_label = tk.Label(
        window,
        text='QTI Maker – Create quizzes in QTI format from Markdown-based plain text',
        font=(None, 16),
    )
    header_label.grid(
    ...
    header_link_label.bind('<Button-1>', lambda x: webbrowser.open_new('https://github.com/gpoore/qtimaker'))
    ...
    qti_version_label = tk.Label(
        window,
        text='QTI Version:',
        justify='right',
    )
    qti_version_label.grid(
        row=current_row, column=0, padx=(30, 5), pady=(5, 5),
        sticky='nse',
    )
    qti_version_var = tk.StringVar(value='1.2')
    qti_version_frame = tk.Frame(window)
    qti_version_frame.grid(
        row=current_row, column=1, columnspan=column_count-1, padx=(0, 30), pady=(5, 5),
        sticky='w',
    )
    qti_version_1_2 = tk.Radiobutton(
        qti_version_frame,
        text='1.2 (Classic Quizzes)',
        variable=qti_version_var,
        value='1.2',
    )
    qti_version_1_2.pack(side='left', padx=(0, 20))
    qti_version_2_1 = tk.Radiobutton(
        qti_version_frame,
        text='2.1 (New Quizzes)',
        variable=qti_version_var,
        value='2.1',
    )
    qti_version_2_1.pack(side='left')
    current_row += 1
    ...
    def run():
        ...
        try:
            ...
            qti_version = qti_version_var.get()
            qti = QTI(quiz, qti_version=qti_version)
