...
_latex_templates = {
    'header': textwrap.dedent(
        r'''
        %%%% Begin qtimaker custom preamble
        % Page layout
...
_html_templates = {
    'header': textwrap.dedent(
        ...
        div.qtimaker-randomized > ul {
            list-style-position: outside;
            margin-left: -0.5em;
        }
        div.qtimaker-randomized > ul > li {
            list-style-type: "[?]";
            padding-left: 0.5em;
        }
        ul.qtimaker {
        ...
        ul > li.qtimaker-mctf-choice::marker, ul > li.qtimaker-mctf-correct-choice::marker {
            font-size: 1.5em;
        }
        ul > li.qtimaker-mctf-choice, ul > li.qtimaker-mctf-correct-choice {
            margin-top: -0.5em;
        }
        li.qtimaker-mctf-choice {
            list-style-type: "○";
            padding-left: 0.5em;
        }
        li.qtimaker-mctf-correct-choice {
            list-style-type: "●";
            padding-left: 0.5em;
        }
        li.qtimaker-multans-choice {
            list-style-type: "☐";
            padding-left: 0.5em;
        }
        li.qtimaker-multans-correct-choice {
            list-style-type: "☑";
            padding-left: 0.5em;
        }
        li.qtimaker-generic-correct {
            list-style-type: "🡆";
            padding-left: 0.5em;
        }
        ul > li.qtimaker-solution::marker {
            font-size: 1.75em;
        }
        ul > li.qtimaker-solution {
            margin-top: -0.25em;
        }
        li.qtimaker-solution {
            list-style-type: "🗈";
            padding-left: 0.5em;
        }
        </style>
    ...
    'mctf_choice_start': '<li class="qtimaker-mctf-choice">',
    'mctf_choice_end': '</li>',
    'mctf_correct_choice_start': '<li class="qtimaker-mctf-correct-choice">',
    'mctf_correct_choice_end': '</li>',
    'multans_choice_start': '<li class="qtimaker-multans-choice">',
    'multans_choice_end': '</li>',
    'multans_correct_choice_start': '<li class="qtimaker-multans-correct-choice">',
    'multans_correct_choice_end': '</li>',
    'generic_correct_choice_start': '<li class="qtimaker-generic-correct">',
    'generic_correct_choice_end': '</li>',
    'choices_start': '<ul class="qtimaker">',
    'choices_end': '</ul>',
    'solution_start': '<ul class="qtimaker"><li class="qtimaker-solution">',
    'solution_end': '</ul></li>',
    ...
    'random_questions_start': '<div class="qtimaker-randomized">',
